...
#define FTP_SELECTOR_OPTION 'F'
#define FTP_SELECTOR_OPTION_LINE 7
#define DELAY_TOGGLE_SELECTOR_OPTION 'D'
#define DELAY_TOGGLE_SELECTOR_OPTION_LINE FTP_SELECTOR_OPTION_LINE + 2
...
#define ALLOWED_KEYS "123456DWCREF"   // Only these keys are allowed
...
static MenuItem menuItems[] = {
    ...
    {FTP_SELECTOR_OPTION, FTP_SELECTOR_OPTION_LINE, "Start FTP Server"},
...
static __int8_t delay_toogle_selector_index = 7;
